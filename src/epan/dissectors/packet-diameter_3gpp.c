 ...
 *
 * $Id: packet-diameter_3gpp.c 49304 2013-05-14 20:48:01Z morriss $
 *
...
static int
dissect_diameter_3gpp_sgsn_ipv6_address(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree)
{
    ...
    return dissect_diameter_3gpp_ipv6addr(tvb, pinfo, tree);
